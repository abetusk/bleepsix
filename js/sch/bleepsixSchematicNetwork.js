...
function bleepsixSchematicNetwork( serverURL, muteFlag )
{
  this.serverURL = ( (typeof serverURL === 'undefined') ? 'https://localhost' : serverURL );
...
bleepsixSchematicNetwork.prototype.projectauthResponse = function( data )
{
            ...
            (this.usingUrlProjectFlag) )
  {
    ...
    {
      window.history.replaceState( {}, 'title', '/sch' );
    }
